  ...
  return (
    <>
      <header className="w-full fixed top-0 left-0 bg-amber-600 shadow-md flex items-center h-16 justify-between-px-4">
        ...
        <div className="social-container ml-auto pr-2 flex gap-2">
          <Socialbutton
            url="https://www.instagram.com/heykeymee/"
            label={
          ...
          <Socialbutton
            url="https://www.linkedin.com/in/hakimihalim21/"
            label={
              <svg xmlns="http://www.w3.org/2000/svg" width={24} height={24} fill={'currentColor'} viewBox="0 0 24 24">
                {/* Boxicons v3.0 https://boxicons.com | License  https://docs.boxicons.com/free */}
          ...
          <Socialbutton
            url="https://www.facebook.com/hakimi.halim.50/"
            label={
              <svg xmlns="http://www.w3.org/2000/svg" width={24} height={24} fill={'currentColor'} viewBox="0 0 24 24">
                {/* Boxicons v3.0 https://boxicons.com | License  https://docs.boxicons.com/free */}
